...
;;;; Motion state
  ...
  (modal-motion-set-key "s SPC" #'modal-select-inner-line)
  ;; (modal-motion-set-key "s S" #'modal-select-whole-line)
  (modal-motion-set-key "S" #'modal-select-lines)
  (modal-motion-set-key "e" #'modal-word-end)
  (modal-motion-set-key "b" #'modal-word-begin)
  (modal-motion-set-key "E" #'modal-select-to-word-end)
  (modal-motion-set-key "B" #'modal-select-to-word-begin)
